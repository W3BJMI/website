...
export function MemberCard({ designation, name, image }){
    ...
    return (
        <div className="ml-10 md:ml-10 mt-20 group relative w-72 h-[29rem] md:w-96 md:h-[29rem] overflow-hidden bg-black rounded-lg shadow-lg cursor-pointer border-x-2 border-slate-700">
