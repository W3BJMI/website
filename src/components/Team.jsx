    ...
    return (
        <div className="bg-black min-h-screen p-6 ">
            ...
            <div className="relative mt-8 px-6">
                ...
                >
                    {teams.map((team, index) => (
                        <div key={index} className="w-full md:min-w-[350px] text-white max-w-sm p-4 rounded-lg shadow-md text-center snap-start">
                            {team.teamHead && (
                                <MemberCard
                                    designation={team.teamName}
                                    name={team.teamHead.name}
                            ...
                            <button
                                onClick={() => navigate(`/team/${team.teamName}`)}
                                className="bg-indigo-700 text-white px-4 py-2 rounded-md hover:bg-indigo-900 transition mt-4 w-auto ml-36"
                            >
                                View Team
                            </button>
                        </div>
