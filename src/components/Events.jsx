...
export default function Events() {
    ...
    return (
        <section ref={sectionRef} id="events" className="bg-black pt-24 text-white w-full pb-10">
            <div className="font-framer font-bold text-5xl md:text-7xl flex justify-center -tracking-[0.07em]">
            ...
            <div className="font-framer font-bold text-5xl md:text-7xl flex justify-center -tracking-[0.07em]" style={{ color: 'rgba(123, 0, 255, 1)' }}>
            ...
            <div className="flex justify-evenly md:justify-center pt-6 text-2xl font-semibold w-[100vw]">
                <div className={`ml-2 mr-6 md:mr-3 pt-3 cursor-pointer ${!isToggleOn ? 'text-purple-600' : 'text-white'}`} onClick={showPreviousEvents}>
                    Previous Events
                </div>
                ...
                <div onClick={toggleSwitch} className={`mr-10 md:mr-3 w-[45%] md:w-[7rem] mt-4 md:mt-0 h-14 flex items-center rounded-full p-2 cursor-pointer ${isToggleOn ? "bg-purple-600" : "bg-gray-300"}`}>
                    <motion.div
                        className={`w-12 h-12 rounded-full ${isToggleOn ? "bg-white" : "bg-purple-700"}`}
                        layout
                        transition={{ type: "spring", stiffness: 700, damping: 30 }}
                        initial={false}
                        animate={{ x: isToggleOn ? 48 : 0 }}
                    />
                </div>
                <div className={`pt-2.5 cursor-pointer ${isToggleOn ? 'text-purple-600' : 'text-white'}`} onClick={showUpcomingEvents}>
                    Upcoming Events
                </div>
            </div>
            <div>
