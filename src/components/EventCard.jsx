...
export function EventCard({ position, title, description, cardTitle, imageUrl ,eventid}) {
    ...
    return (
        ...
        >
            {/* Card */}
            <motion.div
                className="relative w-full max-w-[90%] md:w-[40rem] h-72 md:h-[32rem] ml-5 rounded-tl-[32px] rounded-br-[32px] rounded-tr-[106px] rounded-bl-[106px] overflow-hidden shadow-lg"
                initial="hidden"
                whileInView="visible"
                    ...
                    <div className="ml-2 md:ml-4 mb-4 md:mb-7">
                        <button onClick={handleClick} className="w-12 h-12 md:w-14 md:h-14 bg-purple-800 rounded-full hover:bg-purple-700 transition duration-300">
                            <svg
                                ...
                                strokeWidth={1}
                                stroke="currentColor"
                                className="size-6 md:size-7 ml-3 md:ml-3.5 "
                            >
                                <path
                                    strokeLinecap="round"
